...
namespace SampleWbFormsApp.Hackathon2
{
    public partial class Test01Search : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //Words[key] = txtTranslation.Text.Trim();
            //Response.Redirect("Test01Words.aspx");

            string word = txtSearch.Text.Trim();
            string translation = txtTranslation.Text.Trim();

            Words[word] = translation; // Adds or updates the translation

            // Optionally show a message (ensure Label1 exists in your ASPX)
